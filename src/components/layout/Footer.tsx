        ...
        <div className="px-4 py-8">
          ...
          <div className="flex justify-center space-x-4 mb-8">
            {[
              ...
              <a key={index} href="#" className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300 mobile-touch-feedback border border-gray-200">
          ...
          <div className="grid gap-8 lg:grid-cols-6">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-white rounded-lg flex items-center justify-center hover:bg-gray-100 hover:scale-110 transition-all duration-300 shadow-md hover:shadow-lg group border border-gray-200">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-1 bg-white px-3 py-1 rounded-lg transition-all duration-300 border border-gray-200 shadow-sm">
                    <svg className="w-4 h-4 text-green-600 transition-colors duration-300" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-xs text-gray-700 transition-colors duration-300">SSL</span>
                  </div>
                </div>
              </div>
            </div>
