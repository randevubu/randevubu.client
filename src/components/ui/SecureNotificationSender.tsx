...
type BroadcastNotificationType = Extract<NotificationType, 'HOLIDAY' | 'PROMOTION' | 'BROADCAST'>;

const NOTIFICATION_TYPES: { value: BroadcastNotificationType; label: string; description: string }[] = [
  {
    value: 'HOLIDAY',
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setFormData((prev) => ({
                  ...prev,
                  notificationType: e.target.value as BroadcastNotificationType,
                }))
              }
