...
import { AlertCircle, ChevronDown, Clock, CreditCard, FileText, Grid3X3, List, Plus, RefreshCw, Search, Trash2, X } from 'lucide-react';
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--theme-primary)] ${errors.name ? 'border-red-500' : 'border-[var(--theme-border)]'
                    }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--theme-primary)] ${errors.duration ? 'border-red-500' : 'border-[var(--theme-border)]'
                    }`}
                  min="1"
                  step="1"
                  placeholder="60"
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className={`flex-1 min-w-0 px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--theme-primary)] ${errors.price ? 'border-red-500' : 'border-[var(--theme-border)]'
                      }`}
                    min="0"
                    step="0.01"
                    placeholder="0"
      ...
      <div className="bg-[var(--theme-card)] rounded-lg shadow-sm border border-[var(--theme-border)] p-4 sm:p-6 transition-colors duration-300">
        <div className="flex justify-end mb-4 gap-2">
          <button
            onClick={() => {
              refetchServices();
              showSuccessToast('Hizmetler yenilendi');
            }}
            className="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2 bg-[var(--theme-backgroundSecondary)] text-[var(--theme-foreground)] text-sm font-medium rounded-lg hover:bg-[var(--theme-border)] transition-colors border border-[var(--theme-border)]"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center bg-[var(--theme-backgroundSecondary)] rounded-lg p-1">
            <button
              ...
              className={`p-2 rounded-md transition-colors ${viewMode === 'detailed'
                ...
                <div className="flex flex-col lg:flex-row lg:items-start gap-4">
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${service.isActive
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <ChevronDown
                              className={`w-5 h-5 text-[var(--theme-foregroundMuted)] transition-transform ${isExpanded ? 'rotate-180' : ''
                                }`}
                            />
                          </div>
                        </div>
