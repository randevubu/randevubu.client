...
import { customerService, Customer, CustomerDetails, GetCustomersParams, BanCustomerRequest } from '../../../src/lib/services/customers';
import { canViewBusinessStats } from '../../../src/lib/utils/permissions';
import { handleApiError } from '../../../src/lib/utils/toast';
import { useValidationErrors } from '../../../src/lib/hooks/useValidationErrors';
import { banCustomerSchema } from '../../../src/lib/validation/customers';
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              {customer.currentStrikes && customer.currentStrikes > 0 && (
